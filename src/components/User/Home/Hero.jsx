...
function Hero() {
  return (
    <div className='relative w-full md:h-[80vh] overflow-hidden group h-[60vh] '> 
        <img src="/public/images/heroimg.jpg" className=' object-cover w-full md:object-left-top md:w-full h-full transform  transition-transform duration-500 group-hover:scale-110' alt="" />
